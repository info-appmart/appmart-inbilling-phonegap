...
public class PhoneGapPlugin {
		...
		/* private Constructor */
		private PhoneGapPlugin(Context context) {
			mContext = context ;
		}
		
		/* インスタンス取得 */
		public static PhoneGapPlugin getInstance(Context context){ 		
			return new PhoneGapPlugin(context);					
		}
		
		/* パラメータ設定 */
		public PhoneGapPlugin setParameters(String devId,String  licenceKey, String  publicKey, String appId){
			this.devId=devId;
